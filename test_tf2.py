...
input_name = 'input:0' if test_resnet else 'prefix/image_tensor:0'
output_names = ['output:0'] if test_resnet else ['prefix/num_detections:0', 'prefix/detection_boxes:0', 'prefix/detection_classes:0']
...
if True:
    ...
    if test_resnet:
        ...
        image = image.astype(np.float32) / std
